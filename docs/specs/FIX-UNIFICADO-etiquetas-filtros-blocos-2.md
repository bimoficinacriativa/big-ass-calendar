...
2. **Empilhamento proporcional** em ANO e QUARTER (espaço dividido igualmente por N etiquetas, sem setas, posição vertical consistente em multi-dia). Ordenação ANO/QUARTER: solo no topo, multi-dia embaixo.
